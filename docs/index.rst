...
It offers an intuitive syntax, automatic rendering, interactive features (like zoom/pan, hover tooltips, and export), and works across **Jupyter notebooks**, **CLI**, and **IDEs** — all without requiring explicit `fig.show()` calls.
